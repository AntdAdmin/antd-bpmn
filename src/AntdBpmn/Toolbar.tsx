...
const Toolbar: React.FC<{
    ...
    function toggleMinimap() {
        (modeler.get("minimap") as any).toggle();
    }
    ...
    return (
        <>
            ...
            <Space>
                ...
                <Space.Compact block>
                    <Tooltip title="小地图">
                        <Button style={{padding: "5px 0 0", width: "40px"}} onClick={toggleMinimap} icon={
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <Tooltip title="快捷键">
                        <Button style={{padding: "5px 0 0", width: "40px"}} onClick={() => setShortcutKeysOpen(true)}
                                icon={
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
